...
// configuration step. It creates a namespace called `cmake_template_demo`. You can modify
...
int main(int argc, const char **argv)
{
  ...
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_template_demo::cmake::project_name, cmake_template_demo::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_template_demo::cmake::project_version);
      return EXIT_SUCCESS;
    }
